...
class TetrisView : View {
    ...
    private fun updateScores(){
        ...
        activity?.tvHingScore?.text = "${activity?.appPreferences?.getHingScore()}"
    }
    ...
    override fun onSizeChanged(width: Int, height: Int, previousWidth: Int, previousHeight: Int) {
        super.onSizeChanged(width, height, previousHeight, previousWidth)
